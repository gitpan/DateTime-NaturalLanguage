# This Makefile is for the DateTime::NaturalLanguage extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/DateTime/NaturalLanguage.pm]
#     AUTHOR => q[Luke Hutscal <hybrid.basis@gmail.com>]
#     NAME => q[DateTime::NaturalLanguage]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/DateTime/NaturalLanguage.pm]
...
NAME_SYM = DateTime_NaturalLanguage
VERSION = 0.03
...
FULLEXT = DateTime/NaturalLanguage
BASEEXT = NaturalLanguage
PARENT_NAME = DateTime
DLBASE = $(BASEEXT)
VERSION_FROM = lib/DateTime/NaturalLanguage.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/DateTime/NaturalLanguage.pm
...
TO_INST_PM = lib/.DS_Store \
	lib/DateTime/.DS_Store \
	lib/DateTime/NaturalLanguage.pm

PM_TO_BLIB = lib/DateTime/NaturalLanguage.pm \
	blib/lib/DateTime/NaturalLanguage.pm \
	lib/DateTime/.DS_Store \
	blib/lib/DateTime/.DS_Store \
	lib/.DS_Store \
	blib/lib/.DS_Store
...
DISTNAME = DateTime-NaturalLanguage
DISTVNAME = DateTime-NaturalLanguage-0.03
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/DateTime/NaturalLanguage.pm $(INST_MAN3DIR)/DateTime::NaturalLanguage.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         DateTime-NaturalLanguage' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.03' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/DateTime/NaturalLanguage.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for converting seconds to "natural" time values.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Luke Hutscal &lt;hybrid.basis@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/DateTime/NaturalLanguage.pm blib/lib/DateTime/NaturalLanguage.pm \
	  lib/DateTime/.DS_Store blib/lib/DateTime/.DS_Store \
